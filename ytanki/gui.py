...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5 = QtWidgets.QLabel(self.export_settings_box)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_7.addWidget(self.label_5)
        self.note_type_field = QtWidgets.QComboBox(self.export_settings_box)
        ...
        self.label_7 = QtWidgets.QLabel(self.export_settings_box)
        self.label_7.setObjectName("label_7")
        self.verticalLayout_9.addWidget(self.label_7)
        self.audio_field = QtWidgets.QComboBox(self.export_settings_box)
        ...
        self.label_8 = QtWidgets.QLabel(self.export_settings_box)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_10.addWidget(self.label_8)
        self.picture_field = QtWidgets.QComboBox(self.export_settings_box)
        ...
        self.label_6 = QtWidgets.QLabel(self.export_settings_box)
        self.label_6.setObjectName("label_6")
        self.verticalLayout.addWidget(self.label_6)
        self.text_field = QtWidgets.QComboBox(self.export_settings_box)
        ...
        self.subtitle_settings_box = QtWidgets.QGroupBox(self.centralwidget)
        ...
        self.label_4 = QtWidgets.QLabel(self.subtitle_settings_box)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_4.addWidget(self.label_4)
        self.language_field = QtWidgets.QComboBox(self.subtitle_settings_box)
        self.language_field.setObjectName("language_field")
        self.horizontalLayout_4.addWidget(self.language_field)
        self.verticalLayout_6.addLayout(self.horizontalLayout_4)
        self.fallback_checkbox = QtWidgets.QCheckBox(self.subtitle_settings_box)
        self.fallback_checkbox.setObjectName("fallback_checkbox")
        self.verticalLayout_6.addWidget(self.fallback_checkbox)
        self.optimize_checkbox = QtWidgets.QCheckBox(self.subtitle_settings_box)
        ...
        self.limit_desc = QtWidgets.QLabel(self.groupBox)
        self.limit_desc.setAlignment(
        ...
        self.picture_settings_box = QtWidgets.QGroupBox(self.centralwidget)
        ...
        self.label_10 = QtWidgets.QLabel(self.picture_settings_box)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred
        )
        sizePolicy.setHorizontalStretch(0)
        ...
        self.width_input = QtWidgets.QSpinBox(self.picture_settings_box)
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        self.label_2 = QtWidgets.QLabel(self.picture_settings_box)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_11.addWidget(self.label_2)
        self.height_input = QtWidgets.QSpinBox(self.picture_settings_box)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred
        )
        sizePolicy.setHorizontalStretch(0)
        ...
        self.height_input.setAlignment(
            QtCore.Qt.AlignLeading | QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop
        )
        self.height_input.setMaximum(2160)
        self.height_input.setObjectName("height_input")
        self.verticalLayout_11.addWidget(self.height_input, 0, QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.subtitle_settings_box.setTitle(
            _translate("MainWindow", "Subtitle Settings")
        )
        self.label_4.setText(_translate("MainWindow", "Language"))
        self.fallback_checkbox.setText(
            _translate("MainWindow", "Fallback to auto-captions")
        )
        ...
        self.picture_settings_box.setTitle(
            _translate("MainWindow", "Picture Dimensions (px)")
        )
