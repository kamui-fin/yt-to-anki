...
def test_01_parsing_subtitles():
    ...
    assert optimized_subtitles[0].time_start == "00:00:00.049"
    assert optimized_subtitles[0].time_end == "00:00:09.630"
    assert optimized_subtitles[0].text == (
        "What if doing well in school and in life depends on much more "
        "than your ability to learn quickly and easily?"
    )

    assert optimized_subtitles[1].time_start == "00:00:09.630"
    assert optimized_subtitles[1].time_end == "00:00:20.259"
    assert (
    ...
    assert optimized_subtitles[13].time_start == "00:01:08.760"
    assert optimized_subtitles[13].time_end == "00:01:21.640"
    assert (
